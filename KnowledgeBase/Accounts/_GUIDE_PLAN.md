...
| 2026-04-11 | K       | Phase A (top 3 critical gaps): NEW §16 Recurring Transactions (9 captures `17-1`..`17-9` + 4 subsections: concept, modal, processing, pause/resume/cancel); NEW §17 Budgets & Variance (7 captures `18-1`..`18-7` + 4 subsections: why, create with monthly breakdown, budget vs actual, copy from prior year); NEW §15.1.6 Statement Import sub-section in Banking (4 captures `12H-32`..`12H-35` + full workflow download→paste→upload→preview→confirm). Bumped §16 Glossary to §18. TOC updated. | 2 (#58 recurring template_data content validation, #59 budgets monthly sum must match annual) |
