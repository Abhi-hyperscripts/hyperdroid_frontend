...
window.ACCOUNTS_HELP = {
    ...
    'banking:bank-transactions':
        `<p><strong>The register of money in and out of one bank account.</strong> Most rows appear automatically from payments; use <strong>Record Transaction</strong> for things that bypass documents — bank charges, interest, owner deposits. Every manual row needs a <strong>counter account</strong>: the "other side" that explains WHY money moved.</p>
         <p><strong>Example:</strong> the bank debits ₹590 IMPS charges. Record a withdrawal of ₹590 with counter account <em>Repairs &amp; Maintenance? No — Bank Charges (an expense)</em>. Bank down ₹590, expense up ₹590. Without the counter account the books couldn't say what the money became.</p>`,
