...
(function () {
  ...
  var PRESETS = {
    ...
    /* HRMS, CRM, Projects, Procurement, Learning, Research, Mail, Meetings
       and AI feature pages. */
    analysis:       [62442, 26, 0.44, 3],
    attendance:     [3971, 30, 0.72, 6],
    calls:          [16477, 34, 0.68, 3],
    certs:          [47804, 38, 0.62, 6],
    coding:         [57524, 42, 0.56, 3],
    compare:        [50626, 46, 0.5, 6],
    compose:        [17212, 26, 0.44, 3],
    crmreports:     [69194, 30, 0.72, 6],
    deals:          [39258, 34, 0.68, 3],
    employees:      [86344, 38, 0.62, 6],
    fbleads:        [38403, 42, 0.56, 3],
    features:       [26771, 46, 0.5, 6],
    files:          [71895, 26, 0.44, 3],
    hrreports:      [54603, 30, 0.72, 6],
    journey:        [81935, 34, 0.68, 3],
    leads:          [16205, 38, 0.62, 6],
    leave:          [74579, 42, 0.56, 3],
    mailbox:        [65372, 46, 0.5, 6],
    messages:       [28021, 26, 0.44, 3],
    paths:          [61338, 30, 0.72, 6],
    pmsproj:        [12655, 34, 0.68, 3],
    pmstasks:       [36567, 38, 0.62, 6],
    pmstime:        [32518, 42, 0.56, 3],
    quest:          [24878, 46, 0.5, 6],
    quiz:           [27008, 26, 0.44, 3],
    recruit:        [29817, 30, 0.72, 6],
    rfq:            [9533, 34, 0.68, 3],
    selfservice:    [31417, 38, 0.62, 6],
    sequences:      [52015, 42, 0.56, 3],
    sheets:         [61716, 46, 0.5, 6],
    statutory:      [37940, 26, 0.44, 3],
    teams:          [78597, 30, 0.72, 6],
    transcripts:    [82313, 34, 0.68, 3],
    vendors:        [41490, 38, 0.62, 6],
    whatsapp:       [16618, 42, 0.56, 3],
